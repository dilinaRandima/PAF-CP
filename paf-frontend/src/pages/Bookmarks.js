                        ...
                        <>
                          ...
                          {post?.instructions && post.instructions.trim() !== '' && (
                            <div className="mb-2">
                              ...
                              <ul className="mb-2 ps-3" style={{ fontSize: '0.97em', maxHeight: isInstructionsExpanded ? 'none' : 90, overflow: isInstructionsExpanded ? 'visible' : 'hidden' }}>
                                {(Array.isArray(post.instructions) ? post.instructions : post.instructions.split('\n')).slice(0, isInstructionsExpanded ? undefined : 6).map((step, idx) => (
                                  <li key={idx}>{step}</li>
                                ))}
                              </ul>
